	...
	<div class="joinMain">
		...
		<div class="mArticle">
			...
			<form method="get" name="form">
				<div class="divlist2">
		    <c:forEach items="${sellerinfoget}" var="user">
		    <div>
		    <strong class="tf_required">상점명</strong>
		    <div class="divlist">
		    <input type="text" name="sName" id="sName" class="lab_placeholder" 
		     required="" value="${user.SNAME}" >
		    ...
		    <hr/>
				...
				<div>
					<div class="divlist">
						<input type="submit" value="정보수정" class="updateseller" id="updateseller"
							 /> 
						<input type="submit" value="정보삭제" class="deleteseller" id="deleteseller"
							 />
					</div>
				</div>
			</form>
