...
<body class="animsition">
	...
	<div class="joinMain">
		...
		<!-- 시장정보 페이지 시작 -->
		<div class="mArticle">
			<h2 class="myth theme_color joinfont">시장관리자 정보</h2>
			<form method="get" name="form">
				<div class="divlist2">
		    <c:forEach items="${marketinfoget}" var="user">
		    <div>
		    <strong class="tf_required">담당시장</strong>
		    <div class="divlist">
		    <input type="text" name="mkName" id="mkName" class="lab_placeholder" 
		     required="" value="${user.MKNAME}" >
		    ...
		    <hr/>
				...
				<div>
					<div class="divlist">
						<input type="submit" value="정보수정" class="updatemarket" id="updatemarket"
							 /> 
						<input type="submit" value="정보삭제" class="deletemarket" id="deletemarket"
							 />
					</div>
				</div>
			</form>
