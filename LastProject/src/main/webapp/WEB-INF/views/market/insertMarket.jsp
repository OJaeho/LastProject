	...
	<div class="joinMain">
		<div class="mArticle">
			...
			<div>
				...
				<br /> <strong class="tf_required">회원가입약관</strong>
				<div>
...
위 개인정보의 수집 및 이용에 대한 동의를 거부할 수 있으나, 동의를 거부할 경우 회원 가입이 제한됩니다.
                   ...
                   name="infoTermsYN" value="N"> 동의하지
							...
							<!-- 회원가입 정보입력 시작 -->
							<div>
								<form method="get" action="saveMarket.master" id="frm">
									<h2 class="myth theme_color joinfont">관리자 정보입력</h2>
									<div class="divlist">
										<div>
									...
									<!-- 마켓 정보입력 시작-->
									<h2 class="myth theme_color joinfont">시장 정보입력</h2>
									<div>
										<strong class="tf_required">시장명</strong>
										<div class="divlist">
											<input type="text" name="mkName" id="mkName"
												class="lab_placeholder" placeholder="시장이름을 입력해 주세요"
												required=""> <span id="idCheckResult"
												style="width: 150px; color: red"></span>
										</div>
									</div>
									<div>
										...
										<div class="divlist">
											<input type="text" name="mkOwner" id="mkOwner"
												class="lab_placeholder" placeholder="시장대표자를 입력해 주세요"
												required=""> <span id="idCheckResult"
												style="width: 150px; color: red"></span>
										</div>
									</div>
									<div>
										...
										<div class="divlist">
											<input type="text" name='mkPost' id="sample5_postcode"
												class="lab_placeholder" placeholder="우편번호">
											<div class="divlist2">
												<input type="button" onclick="sample5_execDaumPostcode()"
													class="btn_area join-btn" value="우편번호 찾기">
											</div>
											<input type="text" name="mkaddr" id="sample5_address"
												class="lab_placeholder" placeholder="주소"><br> <input
												type="text" name="mkdetailAddr" id="sample5_detailAddress"
									...
									<div>
										...
										<div class="divlist">
											<input placeholder="전화번호 (-)없이 입력" required=""
												class="lab_placeholder" type="text" name="mkTel" id="mkTel">
											<span id="telCheckResult" style="width: 150px; color: red"></span>
										</div>
									</div>
									...
									<div>
										...
										<div class="divlist">
											<input type="text" name="mkCount" id="mkCount"
												class="lab_placeholder" placeholder="상점보유수를 숫자로만 입력해 주세요"
												required=""> <span id="idCheckResult"
												style="width: 150px; color: red"></span>
										</div>
									</div>
									...
									<div>
										...
										<div class="divlist">
											<input type="text" name="mkImg1" id="mkImg1"
												class="lab_placeholder"
												placeholder="예시>https://www.market.co.kr/21769.jpg"
												required=""> <span id="idCheckResult"
												style="width: 150px; color: red"></span>
										</div>
										<div class="divlist">
											<input type="text" name="mkImg2" id="mkImg2"
												class="lab_placeholder"
												placeholder="예시>https://www.market.co.kr/21369.jpg"
												required=""> <span id="idCheckResult"
												style="width: 150px; color: red"></span>
										</div>
									</div>
									<div>
										...
										<div class="divlist">
											<input type="text" name="mkJido" id="mkJido"
												class="lab_placeholder"
												placeholder="예시>https://www.market.co.kr/21169.jpg"
												required=""> <span id="idCheckResult"
												style="width: 150px; color: red"></span>
										</div>
									</div>
									<div>
										...
										<div class="divlist">
											<select name="mkLocal" class="mkLocal"
												style="width: 150px; color: green;">
												<option value="selected" style="color: black;">지역
													선택</option>
									...
									<div>
										...
										<div class="divlist">
											<input type="text" name="mkLat" id="mkLat"
												class="lab_placeholder" placeholder="시장위도를 입력해 주세요"
												required=""> <span id="idCheckResult"
												style="width: 150px; color: red"></span>
										</div>
									</div>
									<div>
										...
										<div class="divlist">
											<input type="text" name="mkLong" id="mkLong"
												class="lab_placeholder" placeholder="시장경도을 입력해 주세요"
												required=""> <span id="idCheckResult"
												style="width: 150px; color: red"></span>
										</div>
									</div>
									<div>
										...
										<div class="divlist">
											<div class="divlist">
												<input type="date" name="mkTime" id="mkTime"
													class="lab_placeholder">
											</div>
										</div>
										<div>
											...
											<div class="divlist">
												<textarea id="summernote" name="mkIntro" id="mkIntro"
													placeholder="시장소개를 입력해 주세요"></textarea>
											</div>
										</div>
										<!-- 마켓 정보입력 끝-->
										<hr />
										<div>
											<div class="divlist">
												<input type="submit" name="submit" id="submit" value="등록"
													class="join-btn" style="width: 250px; border-color: green;">
											</div>
										</div>
									</div>
								</form>
